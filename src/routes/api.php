...
Route::middleware('auth:sanctum')->group(function () {
    ...
    // --- GOALS & MILESTONES ---
    // Route::apiResource sẽ tự động tạo các route GET, POST, PUT, DELETE cho /goals
    Route::apiResource('goals', GoalController::class);
    
    // Các route tùy chỉnh cho Goals
    ...
    // Route cho Milestones (lồng trong Goals)
    ...
    // Quản lý Thùng rác (Trash) của Events
    ...
    Route::prefix('notifications')->controller(NotificationController::class)->group(function () {
        Route::get('/', 'index');
        Route::post('/{notification}/read', 'markAsRead'); // Sửa {notification}
