...
Route::middleware('auth:sanctum')->group(function () {
    ...
    // --- AI Analysis Endpoints (trigger AI microservice) ---
    Route::post('/ai-analysis/goal/{goal}', [AISuggestionController::class, 'analyzeGoal']);
    Route::post('/ai-analysis/priority-suggestions', [AISuggestionController::class, 'getPrioritySuggestions']);
    Route::post('/ai-analysis/completion-forecast', [AISuggestionController::class, 'getCompletionForecast']);
    Route::get('/ai-analysis/user-insights', [AISuggestionController::class, 'getUserInsights']);
    Route::post('/ai-analysis/generate-suggestions', [AISuggestionController::class, 'generateSuggestions']);
    Route::get('/ai-analysis/service-status', [AISuggestionController::class, 'getAIServiceStatus']);
